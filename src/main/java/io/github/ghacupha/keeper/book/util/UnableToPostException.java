 ...
 * does not first ensure that {@code Cash} amounts of {@link AccountSide#CREDIT} {@link Entry} items
 * are not equivalent to the {@code Cash} amounts of {@link AccountSide#CREDIT} {@link Entry} items
 *
 * @author edwin.njeru
 */
